 ...
 * [CreateNewRemainder.OnFragmentInteractionListener] interface
...
class CreateNewRemainder : Fragment(), TimePickerFragment.OnFragmentInteractionListener {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater!!.inflate(R.layout.fragment_create_new_remainder, container, false)
        val btn1: Button = view.findViewById(R.id.discard)
    ...
    fun createReminder(){
        ...
        val reminder = ReminderData(key ,uid, reminder_title.text.toString(),reminder_detail.text.toString(),1, setTime, false, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateNewRemainder.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateNewRemainder().apply {
